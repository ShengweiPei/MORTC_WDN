# -*- coding: utf-8 -*-
"""
Created on Sat Feb 17 23:49:28 2024
...
def Pumpsolution_selection(scenario_num, solution_num):
    path_NN = "E:/MORTC/Anytown/Anytown_NSGAII/" + str(scenario_num) + ".xlsx"
...
def Performance_under_pipe_bursts():
    ...
    for sm in range (200):
        ...
        workbook_res = xlsxwriter.Workbook( "E:/MORTC/Anytown_pipe_bursts/SSO/ " + 'SSO_under pipe bursts '+ str(sm) +'.xlsx')
